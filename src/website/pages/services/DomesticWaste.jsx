            ...
            <div className="row">
              <div className="col-lg-12">
                <div className="breadcroumb-title text-center">
                  <h1>Chất thải sinh hoạt</h1>
                  <h6>
                    <NavLink to="/">Trang chủ</NavLink> <NavLink to="/dichvu" className="text-white">/ Dịch vụ</NavLink> / Chất thải sinh hoạt
                  </h6>
                </div>
              </div>
            </div>
                ...
                <div className="service-details_right">
                  ...
                  <div className="service-details_content">
                    ...
                    <p className="service-details_text-1">
                      ...
                      Americans recycled about 68 percent of the paper they used
                      in 2018. This recovered paper is used to make new paper
                      products, which saves trees and other natural resources.
                      Most community or office recycling programs accept paper
                      and paper products.
                    </p>
                    <p className="service-details_text-2">
                      Check what your community or office program accepts before
                      you put it in the bin. Look for products that are made
                      from recycled paper when you shop. Better yet, consider if
                      you really need to print in the first place.
                    </p>
                    <p className="service-details_text-2">
                  ...
                  <p className="service-details_text-3">
                    Paper gift wrap often is not recyclable when it has a shiny
                    or laminated coating. If you use gift wrap, purchase a type
                    that can be recycled or is made from recycled content. EPA
